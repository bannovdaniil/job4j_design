...
public class Analize {
     ...
     * ---
     * Возможно все это можно было бы реализовать с помощью stream(), но
     ...
     * убрать 1 итерацию #3 (previous.removeAll(current);) коллекция immutable
     * идея отпадает.
     ...
     * берем с таким же успехом List или Set и идем по нему, итераций будет столько же.
     * @param previous - было
     * @param current  - стало
